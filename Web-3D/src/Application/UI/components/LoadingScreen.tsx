                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 01/25/2025</p>
                            <p>Cloud (C)2025 wcuro</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>Cargando Requisitos - Fedora Server</p>
